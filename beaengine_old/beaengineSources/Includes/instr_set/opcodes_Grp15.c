    ...
    if (GV.REGOPCODE == 0) {
        ...
        if (GV.MOD_!= 0x3) {
            ...
            (*pMyDisasm).Instruction.Category = FPU_INSTRUCTION+STATE_MANAGEMENT;
               ...
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "fxsave ");
            #endif
        ...
        if (GV.MOD_!= 0x3) {
            ...
            (*pMyDisasm).Instruction.Category = FPU_INSTRUCTION+STATE_MANAGEMENT;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "fxrstor ");
            #endif
            (*pMyDisasm).Argument2.ArgSize = 512;
        ...
        if (GV.MOD_!= 0x3) {
            ...
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "ldmxcsr ");
            #endif
        ...
        if (GV.MOD_!= 0x3) {
            ...
            (*pMyDisasm).Instruction.Category = SSE_INSTRUCTION+STATE_MANAGEMENT;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "stmxcsr ");
            #endif
        ...
        if (GV.MOD_!= 0x3) {
            ...
            (*pMyDisasm).Instruction.Category = FPU_INSTRUCTION+STATE_MANAGEMENT;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "xsave ");
            #endif
            (*pMyDisasm).Argument1.ArgSize = 512;
            (*pMyDisasm).Argument2.ArgType = REGISTER_TYPE+FPU_REG+MMX_REG+SSE_REG;
            (*pMyDisasm).Argument2.ArgSize = 512;
        ...
        if (GV.MOD_== 0x3) {
            ...
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "lfence ");
            #endif
        }
        else {
            MOD_RM(&(*pMyDisasm).Argument2, pMyDisasm);
            ...
            (*pMyDisasm).Instruction.Category = FPU_INSTRUCTION+STATE_MANAGEMENT;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "xrstor ");
            #endif
            (*pMyDisasm).Argument2.ArgSize = 512;
            (*pMyDisasm).Argument1.ArgType = REGISTER_TYPE+FPU_REG+MMX_REG+SSE_REG;
            (*pMyDisasm).Argument1.ArgSize = 512;
        ...
        if (GV.MOD_== 0x3) {
            (*pMyDisasm).Instruction.Category = SSE2_INSTRUCTION+CACHEABILITY_CONTROL;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "mfence ");
            #endif
        }
        else {
            FailDecode(pMyDisasm);
        ...
        if (GV.MOD_== 0x3) {
            (*pMyDisasm).Instruction.Category = SSE2_INSTRUCTION+CACHEABILITY_CONTROL;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "sfence ");
            #endif
        }
        else {
            GV.OperandSize = 8;
            ...
            (*pMyDisasm).Instruction.Category = SSE2_INSTRUCTION+CACHEABILITY_CONTROL;
            #ifndef BEA_LIGHT_DISASSEMBLY
               (void) strcpy_r((*pMyDisasm).Instruction.Mnemonic, "clflush ");
            #endif
        }
